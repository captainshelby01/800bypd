...
<div class="max-w-7xl mx-auto">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 border-b border-amber-200/60 pb-5">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('home')); ?>" class="bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold px-4 py-2 rounded-full text-xs transition">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
        <div class="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm flex items-center gap-4">
            ...
            <div>
                ...
                <h3 class="text-2xl font-black text-slate-900"><?php echo e($pendingTransfers->count()); ?></h3>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm flex items-center gap-4">
            ...
            <div>
                ...
                <h3 class="text-2xl font-black text-slate-900"><?php echo e($allOrders->count()); ?></h3>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-xs border-collapse">
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php $__empty_1 = true; $__currentLoopData = $pendingTransfers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50/50 transition">
                            <td class="p-3.5 font-bold font-mono text-purple-900"><?php echo e($order->order_number); ?></td>
                            <td class="p-3.5">
                                <span class="font-bold block text-slate-900"><?php echo e($order->customer_name); ?></span>
                                <span class="text-[10px] text-slate-500 block"><i class="fa-solid fa-phone mr-1"></i><?php echo e($order->customer_phone); ?></span>
                                <span class="text-[10px] text-slate-500 block"><i class="fa-solid fa-envelope mr-1"></i><?php echo e($order->customer_email); ?></span>
                            </td>
                            <td class="p-3.5 max-w-xs">
                                <span class="block text-slate-700 font-medium line-clamp-1"><?php echo e($order->shipping_address); ?>, <?php echo e($order->city); ?>, <?php echo e($order->state); ?></span>
                                <?php if($order->special_instructions): ?>
                                    <span class="text-[10px] text-amber-800 bg-amber-50 px-2 py-0.5 rounded border border-amber-200 inline-block mt-1">
                                        <i class="fa-solid fa-note-sticky mr-1"></i><?php echo e($order->special_instructions); ?>

                                    </span>
                                <?php endif; ?>
                            </td>
                            <td class="p-3.5 font-black text-purple-950 text-sm"><?php echo e($order->formatted_total); ?></td>
                            <td class="p-3.5">
                                <?php if($order->bank_transfer_receipt): ?>
                                    <a href="<?php echo e(asset('storage/' . $order->bank_transfer_receipt)); ?>" target="_blank" class="bg-emerald-50 text-emerald-700 border border-emerald-300 px-3 py-1.5 rounded-xl font-bold text-[10px] hover:bg-emerald-100 inline-flex items-center gap-1.5 shadow-sm">
                            ...
                            <td class="p-3.5 text-right space-x-2">
                                <form action="<?php echo e(route('admin.verifications.approve', $order->id)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form action="<?php echo e(route('admin.verifications.reject', $order->id)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
            ...
            <table class="w-full text-left text-xs border-collapse">
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php $__empty_1 = true; $__currentLoopData = $allOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50/50 transition">
                            <td class="p-3.5 font-bold font-mono text-purple-900"><?php echo e($order->order_number); ?></td>
                            <td class="p-3.5 font-bold text-slate-800"><?php echo e($order->customer_name); ?></td>
                            <td class="p-3.5 font-bold uppercase text-[10px] text-slate-600"><?php echo e(str_replace('_', ' ', $order->payment_method)); ?></td>
                            <td class="p-3.5">
                                <span class="font-bold px-2.5 py-0.5 rounded-full text-[10px] <?php echo e($order->payment_status === 'paid' ? 'bg-emerald-100 text-emerald-800' : 'bg-amber-100 text-amber-900'); ?>">
                                    <?php echo e(strtoupper($order->payment_status)); ?>

                                </span>
                            </td>
                            <td class="p-3.5">
                                <span class="font-semibold text-slate-700 text-xs capitalize"><?php echo e($order->order_status); ?></span>
                            </td>
                            <td class="p-3.5 text-right font-black text-purple-950 text-sm"><?php echo e($order->formatted_total); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\dev\Pastor Pd\resources\views/admin/verifications.blade.php ENDPATH**/ ?>