...
<body class="bg-[#FFFDF9] text-slate-800 flex flex-col min-h-screen">
    ...
    <header class="bg-[#FFFDF9]/90 backdrop-blur-md sticky top-0 z-40 border-b border-amber-100/60 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex items-center justify-between">
            ...
            <nav class="hidden md:flex items-center space-x-9 text-xs font-bold text-slate-700 uppercase tracking-wider">
                <a href="<?php echo e(route('home')); ?>" class="hover:text-purple-700 transition">Home</a>
                <a href="<?php echo e(route('catalog.index', ['category' => 'childrens-story-books'])); ?>" class="hover:text-purple-700 transition">Story Books</a>
                <a href="<?php echo e(route('catalog.index', ['category' => 'jigsaw-puzzles'])); ?>" class="hover:text-purple-700 transition">Jigsaw Puzzles</a>
                <a href="<?php echo e(route('catalog.index', ['category' => 'colouring-books'])); ?>" class="hover:text-purple-700 transition">Colouring Books</a>
            </nav>

            <!-- Search & Shopping Cart -->
            <div class="flex items-center gap-3">
                <form action="<?php echo e(route('catalog.index')); ?>" method="GET" class="relative hidden sm:block">
                ...
                <a href="<?php echo e(route('cart.index')); ?>" class="relative bg-[#2D1B4E] hover:bg-purple-900 text-white px-5 py-2.5 rounded-full font-bold text-xs flex items-center gap-2 shadow-md transition">
                    <i class="fa-solid fa-bag-shopping text-sm text-amber-400"></i>
                    <span>Cart</span>
                    <?php $cartCount = count(session('cart', [])); ?>
                    <span id="cartCountBadge" class="bg-[#FBBF24] text-[#2D1B4E] font-black px-2 py-0.5 rounded-full text-[10px] ml-1"><?php echo e($cartCount); ?></span>
                </a>
            </div>
        </div>
    </header>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-4 w-full">
        <?php if(session('success')): ?>
            <div class="bg-emerald-50 border border-emerald-300 text-emerald-900 px-4 py-3 rounded-2xl relative mb-4 text-xs font-semibold">
                <i class="fa-solid fa-circle-check mr-2 text-sm text-emerald-600"></i> <?php echo e(session('success')); ?>
        ...
        <?php if(session('error')): ?>
            <div class="bg-rose-50 border border-rose-300 text-rose-900 px-4 py-3 rounded-2xl relative mb-4 text-xs font-semibold">
                <i class="fa-solid fa-circle-exclamation mr-2 text-sm text-rose-600"></i> <?php echo e(session('error')); ?>
    ...
    <footer class="bg-[#2D1B4E] text-slate-300 mt-20 py-14 border-t-4 border-[#FBBF24]">
        ...
        <div class="text-center text-slate-400 border-t border-purple-900 mt-12 pt-6 text-xs">
            &copy; <?php echo e(date('Y')); ?> <strong>800bypd</strong> (WrittenbyPD). All rights reserved. Designed to International E-Commerce Standards.
        </div>
    </footer>
...
<?php /**PATH C:\Users\USER\dev\Pastor Pd\resources\views/layouts/app.blade.php ENDPATH**/ ?>